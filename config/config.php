...
define('APP_DESCRIPTION', 'A comprehensive project management system for development teams to securely track and manage projects');
...
define('BASE_URL', 'http://localhost/juniata/code-bunker/'); //temporary due to local testing
